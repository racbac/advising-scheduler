			...
			<div class="BackDiv">
				...
				<form action="createAppt.php" method="post" class="Main-Form">		
					...
					<select class="inputField" name="sessionLeader" required>
						...
						<option value="cpowers1" <?php stickySelect("sessionLeader", "cpowers1", "cmns") ?> >Ms. Christine Powers</option>
						<option value="cmns" <?php stickySelect("sessionLeader", "cmns", "cmns") ?> >CMNS Advisors</option>
					</select>
