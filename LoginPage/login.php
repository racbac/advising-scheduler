...
<html>
    ...
    <body>
		...
		<div class="Restraint">
			<form class="Main-Form" action="processLogin.php" method="post">
				...
				<div id="Buttons">
					<button id="Login" class="submit"><span>login</span></button>
				</div>
			</form>	
			<form class="Main-Form" action="createAccount.php"><button class="button"><span>create new account</span></button></form>
		</div>
		<div id="Inner-Footer">
